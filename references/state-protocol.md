...
- Use a temp file next to the target file for atomic replacement when rebuilding snapshots. The TypeScript extension writes `AUTORESEARCH_STATE.json` with temp-file plus rename.
